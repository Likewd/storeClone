...
const WomenMenColthing = () => {
    const [actvie, setactive] = useState(1)
    const [open, setopen] = useState(false)
    return (
        <div className=" xs:px-[3px]  mm:px-1 sm:px-3 md:px-8 lg:px-16 py-5">
            <div className=" flex items-center justify-between border-b-2 pb-2 ">
                <h2 className='relative before:rounded-md before:absolute before:h-1 before:bg-buttonColor before:w-[100%] before:-left-[1px] before:-bottom-[11px]   font-fontArimo font-extrabold text-backgroundBlack text-[20px]'>Men’s & Women’s Clothing</h2>

                <div className="hidden sm:flex items-center justify-center gap-3">
                    <button onClick={() => {
                        setactive(1)

                    }} className={`${actvie === 1 ? "  border-white border-2 border-b-buttonColor  text-buttonColor" : "bg-transparent text-[#444444] border border-white"}   text-[14px] cursor-pointer outline-none font-fontArimo`}>Men</button>
                    <button onClick={() => {
                        setactive(2)

                    }} className={`${actvie === 2 ? " border-white border-2 border-b-buttonColor  text-buttonColor" : "bg-transparent text-[#444444] border border-white"}   text-[14px] cursor-pointer outline-none font-fontArimo`}>Women</button>
                </div>
            ...
            <div className="py-3 px-1  flex justify-between sm:items-center sm:justify-center lg:justify-between flex-wrap md:gap-7 lg:gap-12 xl:gap-16">
                ...
                <div className="   xs:w-[140px] mm:w-40  ml:w-44  ">
                    ...
                    <div className=" relative   bg-[rgb(248,248,248)]  mm:p-4  flex items-center min-h-[215px] justify-center">
                        ...
                        <Image src={populerProduct2} preview={false} alt='populerProduct' className='object-cover h-40'></Image>
                    </div>
                    <div className="">
                        <div className="">
                            <h2 className='text-[#444444] font-fontArimo text-[14px] '> Product Name</h2>
...
export default WomenMenColthing